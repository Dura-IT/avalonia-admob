...
public sealed partial class NativeAd
{
    ...
    /// </summary>
    public static readonly StyledProperty<bool> ShowAdvertiserProperty = AvaloniaProperty.Register<
        NativeAd,
        bool
    >(nameof(ShowAdvertiser), NativeAdStyle.Default.ShowAdvertiser);

    /// <summary>
    /// Defines the <see cref="ShowStarRating" /> property.
    /// </summary>
    public static readonly StyledProperty<bool> ShowStarRatingProperty = AvaloniaProperty.Register<
        NativeAd,
        bool
    >(nameof(ShowStarRating), NativeAdStyle.Default.ShowStarRating);
    ...
    /// </summary>
    public static readonly StyledProperty<double> BodyFontSizeProperty = AvaloniaProperty.Register<
        NativeAd,
        double
    >(nameof(BodyFontSize), NativeAdStyle.Default.BodyFontSize);

    /// <summary>
    /// Defines the <see cref="CornerRadius" /> property.
    /// </summary>
    public static readonly StyledProperty<double> CornerRadiusProperty = AvaloniaProperty.Register<
        NativeAd,
        double
    >(nameof(CornerRadius), NativeAdStyle.Default.CornerRadius);

    /// <summary>
    /// Defines the <see cref="Padding" /> property.
    /// </summary>
    public static readonly StyledProperty<Thickness> PaddingProperty = AvaloniaProperty.Register<
        NativeAd,
        Thickness
    >(nameof(Padding), NativeAdStyle.Default.Padding);
