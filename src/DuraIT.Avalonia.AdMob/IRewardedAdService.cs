...
namespace DuraIT.Avalonia.AdMob
{
    ...
    public interface IRewardedAdService
    {
        ...
        /// </summary>
        /// <param name="adUnitId">
        /// The rewarded ad unit id to load. When <see langword="null" /> (the default), the id configured
        /// on <see cref="AdMobOptions.RewardedAdUnitId" /> for the current platform is used. Whenever
        ...
        /// here and none configured on <see cref="AdMobOptions.RewardedAdUnitId" /> for the platform — and
