...
/// <see cref="ServiceCollectionExtensions.AddAdMobBanner"/> and read by <see cref="BannerAd"/>
...
internal static class AdMobRuntime
{
    ...
    /// <summary>
    /// Gets or sets the logger factory <see cref="BannerAd"/> uses to report ad-load outcomes.
